...
describe("SearchItems", () => {
    let searchItems: ItemSearcher;

    beforeEach(() => {
        searchItems = new ItemSearcher(mockPoeApi);
    });
    ...
    describe("makeARequestToAnyItem", () => {
        it("should throw an error if total is 0", async () => {
            ...
            (mockPoeApi.firsRequest as jest.Mock).mockResolvedValue(
                firstResponse,
            );
        ...
        it("should make the second request with the correct arguments", async () => {
            ...
            (mockPoeApi.secondRequest as jest.Mock).mockResolvedValue(
                secondResponse,
            );
